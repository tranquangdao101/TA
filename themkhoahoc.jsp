    ...
    <body>
        ...
        <div id="main">
            <ol class="breadcrumb">
                ...
                <li class="active"><a href="<%= request.getContextPath()%>/view/themkhoahoc.jsp">Thêm khoá học</a></li>
            </ol>
            <div class="col-xs-12">
                
                <form id="category-form" class="form-horizontal col-xl-8 col-lg-9 col-md-10" method="get" action="<%= request.getContextPath()%>/KHController" enctype="multipart/form-data" role="form">
                    <div class="form-group">
                        <label for="name" class="col-sm-3 control-label required">Mã khoá học</label>
                        <div class="col-sm-9">
                            <input name="k_ma" type="number" value="" class="form-control" id="name" placeholder="" required="" maxlength="255">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input name="k_ten" type="text" value="" class="form-control" id="name" placeholder="" required="" maxlength="255">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input name="k_hocphi" type="number" value="" class="form-control" id="name" placeholder="" required="" maxlength="255">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input name="k_chitiet" type="text" value="" class="form-control" id="name" placeholder="" required="" maxlength="255">
                        </div>
                    </div>
