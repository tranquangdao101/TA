            ...
            <div class="col-xs-12">
                ...
                <form id="category-form" class="form-horizontal col-xl-8 col-lg-9 col-md-10" method="get" action="<%= request.getContextPath()%>/HVController" enctype="multipart/form-data" role="form">   
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input name="hv_hoten" type="text" value="" class="form-control" id="auto" placeholder="" required="" maxlength="255">
                        </div>
                    </div>
                    
                    <div class="form-group">
                        <label for="name" class="col-sm-3 control-label required">Số điện thoại</label>
                        <div class="col-sm-9">
                            <input name="hv_sodt" type="number" value="" class="form-control" id="auto" placeholder="" required="" maxlength="255">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input name="hv_email" type="email" value="" class="form-control" id="auto" placeholder="" required="" maxlength="255">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input name="hv_quequan" type="text" value="" class="form-control" id="auto" placeholder="" required="" maxlength="255">
                        </div>
                    </div>
                    
                    <div class="form-group">
                        <label for="name" class="col-sm-3 control-label required">Điểm đầu vào</label>
                        <div class="col-sm-9">
                            <input name="hv_diem" type="number" value="" class="form-control" id="auto" placeholder="" required="" maxlength="255">
                        </div>
                    </div>
                    <div class="form-group">
