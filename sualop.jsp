    ...
    <body>
        ...
        <div id="main">
            ...
            <%
                ...
                Lop l = LopDAO.getLopTheoMa(ma);
            %>
            <div class="col-xs-12">
                <form id="category-form" class="form-horizontal col-xl-8 col-lg-9 col-md-10" method="get" action="<%= request.getContextPath()%>/UPDATELController" enctype="multipart/form-data" role="form">
                    <div class="form-group">
                        <label for="name" class="col-sm-3 control-label required">Mã lớp</label>
                        <div class="col-sm-9">
                            <input name="l_ma" type="hidden" value="<%= l.getL_ma()%>" class="form-control" id="name" placeholder="" required="" maxlength="255" >
                            <input name="l_ma" type="number" value="" class="form-control" id="name" placeholder="<%= l.getL_ma() %>" required="" maxlength="255" disabled>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input name="l_ten" type="text" value="" class="form-control" id="name" placeholder="<%= l.getL_ten() %>" required="" maxlength="255">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            ...
                            <span style="font-size: 10px;color: red;"> Tình trạng cũ : <%= l.getL_trangthai() %> </span>  
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            ...
                            <span style="font-size: 10px;color: red;"> Ngày BĐ cũ : <%= l.getL_datebatdau() %> </span>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input name="l_dateketthuc" type="date" value="" class="form-control" id="name" placeholder=" <%= l.getL_dateketthuc() %>" required="" maxlength="255">
                            <span style="font-size: 10px;color: red;"> Ngày KT cũ : <%= l.getL_dateketthuc()%> </span>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input name="l_trinhdo" type="text" value="" class="form-control" id="name" placeholder="<%= l.getL_trinhdo() %>" required="" maxlength="255">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input name="l_sobuoi" type="number" value="" class="form-control" id="name" placeholder="<%= l.getL_trinhdo() %>" required="" maxlength="255">
                        </div>
                    </div>
