    ...
    <body>
        ...
        <div id="main">
            <ol class="breadcrumb">
                ...
                <li class="active"><a href="<%= request.getContextPath()%>/thuchi/chamcong.jsp">Danh sách chấm công</a></li>
                <li class="active"><a href="<%= request.getContextPath()%>/thuchi/themchamcong.jsp">Thêm </a></li>
            ...
            <div class="col-xs-12">
                ...
                <form id="category-form" class="form-horizontal col-xl-8 col-lg-9 col-md-10" method="get" action="<%= request.getContextPath()%>/HVController" enctype="multipart/form-data" role="form">   
                    ...
                    <div class="form-group">
                        <label for="name" class="col-sm-3 control-label required">Năm</label>
                        <div class="col-sm-9">
                            <input name="thanhtoan" type="number" value="" class="form-control" id="auto" placeholder="" required="" maxlength="255">
                        </div>
                    </div>
                     <div class="form-group">
                        <label for="name" class="col-sm-3 control-label required">Tháng </label>
                        <div class="col-sm-9">
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-3 col-sm-9">
                            <button type="submit" class="btn btn-submit"><small><i class="fa fa-plus"></i></small> Thêm công</button>
                            <a class="btn btn-warning" href="<%= request.getContextPath()%>/thuchi/chamcong.jsp"><small><i class="fa fa-reply"></i></small> Trở về</a>
                        </div>
                    </div>
                </form>
            </div>
